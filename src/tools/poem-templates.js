...
if (analysis) {
pug_html = pug_html + "\u003Cbutton" + (" class=\"analysis show\""+pug_attr("id", `show-analysis--${slug}`, true, false)+" type=\"button\" aria-expanded=\"false\""+pug_attr("aria-controls", `analysis--${slug}`, true, false)) + "\u003EShow analysis\u003C\u002Fbutton\u003E\u003Cdiv" + (" class=\"analysis\""+pug_attr("id", `analysis--${slug}`, true, false)) + "\u003E\u003Cbutton" + (" class=\"analysis hide\""+pug_attr("id", `hide-analysis--${slug}`, true, false)+" type=\"button\""+pug_attr("data-analysis-toggle", `show-analysis--${slug}`, true, false)) + "\u003EHide analysis\u003C\u002Fbutton\u003E";
if (analysis.synopsis && analysis.full) {
pug_html = pug_html + "\u003Cdiv class=\"full-or-synopsis-selector\" data-selected=\"synopsis\"\u003E\u003Cbutton" + (" class=\"analysis selector\""+pug_attr("id", `analysis-select-syno--${slug}`, true, false)+" type=\"button\" aria-pressed=\"true\" data-analysis-select=\"synopsis\"") + "\u003ESynopsis\u003C\u002Fbutton\u003E\u003Cbutton" + (" class=\"analysis selector\""+pug_attr("id", `analysis-select-full--${slug}`, true, false)+" type=\"button\" aria-pressed=\"false\" data-analysis-select=\"full\"") + "\u003EFull Analysis\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003Cdiv" + (" class=\"analysis-panel\""+pug_attr("id", `analysis-syno--${slug}`, true, false)+" data-analysis-panel=\"synopsis\"") + "\u003E\u003Ch2\u003EAnalysis of \u003Cem\u003E" + (null == (pug_interp = titleHtml) ? "" : pug_interp) + "\u003C\u002Fem\u003E (synopsis)\u003C\u002Fh2\u003E";
const processedSynopsis = processAnalysisText(analysis.synopsis)
pug_html = pug_html + (null == (pug_interp = processedSynopsis) ? "" : pug_interp) + "\u003C\u002Fdiv\u003E\u003Cdiv" + (" class=\"analysis-panel\""+pug_attr("id", `analysis-full--${slug}`, true, false)+" data-analysis-panel=\"full\"") + "\u003E\u003Ch2\u003EAnalysis of \u003Cem\u003E" + (null == (pug_interp = titleHtml) ? "" : pug_interp) + "\u003C\u002Fem\u003E\u003C\u002Fh2\u003E";
