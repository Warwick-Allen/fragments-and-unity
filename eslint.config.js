...
module.exports = [
  js.configs.recommended,
  {
    ignores: [
      ...
      // Generated by copyDateUtilsAsset() in build-all-poems.js: a
      // byte-for-byte copy of src/tools/date-utils.js, which the same run
      // already lints. Ignored so a stale copy in a consumer repo (see
      // TD26072501) can't fail lint independently of its source.
